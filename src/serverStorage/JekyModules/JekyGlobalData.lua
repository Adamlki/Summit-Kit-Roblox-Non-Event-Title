...
function JekyGlobalData:SetSkipCheckpointMode(v) if type(v)=="boolean" then PS.Config.Set("SkipCheckpoint",v); return true end; return false end
...
function JekyGlobalData:GetSkipCheckpointMode() return PS.Config.Get("SkipCheckpoint") or false end

                        ...
                        pcall(function() g:Destroy() end)
                            ...
                            local function applyAnim(lbl, animType, colors)
                                ...
                                local conn = RunService.Heartbeat:Connect(function(dt)
                                    ...
                                    local function forceAttachTitle(player)
                                        RunService.Heartbeat:Connect(function()
                                            ...
                                            local data = titleCache[player.UserId]
                                            if not data then return end
                                            
                                            local bb1 = TitleGiver:FindFirstChild("BillboardGui1")
                                            local bb2 = TitleGiver:FindFirstChild("BillboardGui2")
                                            
                                            local existing1 = head:FindFirstChild("BillboardGui1")
                                            if not existing1 and bb1 then
                                            ...
                                            local existing2 = head:FindFirstChild("BillboardGui2")
                                            if not existing2 and bb2 then
